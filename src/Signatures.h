...
namespace Signatures
{
	...
	void Init()
	{
		...
		CAM_Think_sv_cheats						= Find("client.dll", "\x85\xC0\x75\x30\x38\x86\x00\x00\x00\x00\x74\x28\x8B\x0D", "xxxxxx?xxxxxxx");
		...
		IsLoadoutAllowed_IsPlayingDemo			= Find("client.dll", "\x8B\x01\x8B\x80\x48\x01\x00\x00\xFF\xD0\x84\xC0\x75\x13\xE8", "xxxxxxxxxxxxxxx") + 10;
		...
		NET_SendLong							= Find("engine.dll", "\x55\x8B\xEC\x81\xEC\xDC\x04\x00\x00\x8B\x45\x0C\x53\x8B\x5D\x08", "xxxxxxxxxxxxxxxx");
